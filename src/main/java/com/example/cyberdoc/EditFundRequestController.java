...
public class EditFundRequestController implements Initializable {
    ...
    public void updateBtn(){
        ...
        if(pd_status.getSelectionModel().getSelectedItem() == null){
            ...
            String updateData = "UPDATE fund_application SET status = ? " +
                    "WHERE mobile_number = '"
                    + Data.temp_mobileNumber+"'";
            connect = Database.connectDB();

            try {
                if(alert.confirmationMessage("Are you sure you want to UPDATE Fund Request Status ?") ){
    ...
    public void setField(){
        ...
        pd_doctor.setText(Data.temp_doctor);
        pd_referedBy.setText(Data.temp_referedBy);
        pd_amount.setText(Data.temp_amount);
