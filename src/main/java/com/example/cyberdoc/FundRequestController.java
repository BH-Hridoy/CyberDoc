...
public class FundRequestController implements Initializable {
    ...
    @FXML
    private TableView<FundRequestData> recordpage_tableView;



    @FXML
    private TableColumn<FundRequestData, String> fund_address;

    @FXML
    private TableColumn<FundRequestData, String> fund_age;

    @FXML
    private TableColumn<FundRequestData, String> fund_amount;

    @FXML
    private TableColumn<FundRequestData, String> fund_applicantsName;

    @FXML
    private TableColumn<FundRequestData, String> fund_doctor;

    @FXML
    private TableColumn<FundRequestData, String> fund_email;

    @FXML
    private TableColumn<FundRequestData, String> fund_gender;

    @FXML
    private TableColumn<FundRequestData, String> fund_hospitalName;

    @FXML
    private TableColumn<FundRequestData, String> fund_issue;

    @FXML
    private TableColumn<FundRequestData, String> fund_mobile;

    @FXML
    private TableColumn<FundRequestData, String> fund_patientName;

    @FXML
    private TableColumn<FundRequestData, String> fund_referedBy;

    @FXML
    private TableColumn<FundRequestData, String> fund_relation;

    @FXML
    private TableColumn<FundRequestData, String> fund_status;

    @FXML
    private TableColumn<FundRequestData, String> recordpage_col_action;
    ...
    public ObservableList<FundRequestData> getFundRequest(){
        ObservableList<FundRequestData> listData = FXCollections.observableArrayList();

        String selectData = "SELECT  * FROM fund_application WHERE status = '" +"Not Approved"+"'";
        ...
        try {
            ...
            while (result.next()){
                ...
                fundRequestData = new FundRequestData(
    ...
    private ObservableList<FundRequestData> fundData;
    ...
    public void displayPatientsData(){
        ...
        fund_address.setCellValueFactory(new PropertyValueFactory<>("address"));
        ...
        fund_doctor.setCellValueFactory(new PropertyValueFactory<>("doctor"));
        fund_referedBy.setCellValueFactory(new PropertyValueFactory<>("referedBy"));
        fund_amount.setCellValueFactory(new PropertyValueFactory<>("amount"));
        fund_status.setCellValueFactory(new PropertyValueFactory<>("status"));
    ...
    public void actionButtons(){
        ...
        Callback<TableColumn<FundRequestData, String>, TableCell<FundRequestData, String>> cellFactory = (TableColumn<FundRequestData, String> param) -> {
            final TableCell<FundRequestData, String> cell = new TableCell<FundRequestData, String>() {
                    ...
                    if (empty) {
                        ...
                        editButton.setOnAction((ActionEvent event) -> {
                            try {
                                ...
                                FundRequestData pData = recordpage_tableView.getSelectionModel().getSelectedItem();
                                ...
                                Data.temp_referedBy = pData.getReferedBy();
                                Data.temp_status = pData.getStatus();
                                Data.temp_relation = pData.getRelation();
                                Data.temp_address = pData.getAddress();
                                Data.temp_doctor = pData.getDoctor();
                                Data.temp_amount = pData.getAmount();
                                Data.temp_status = pData.getStatus();
                                ...
                                Parent root = FXMLLoader.load(getClass().getResource("EditFundRequests.fxml"));
                                Stage stage = new Stage();
                                stage.setTitle("Edit Fund Request Info || CYBERDOC");
